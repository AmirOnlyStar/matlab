...
static uint8_T c2_emlrt_marshallIn(SFc2_untitledInstanceStruct *chartInstance,
  const mxArray *c2_b_y, const char_T *c2_identifier);
static uint8_T c2_b_emlrt_marshallIn(SFc2_untitledInstanceStruct *chartInstance,
  ...
  const mxArray *c2_st)
{
  ...
  *chartInstance->c2_y = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c2_is_active_c2_untitled = c2_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_b_u, 1)), "is_active_c2_untitled");
...
static void sf_gateway_c2_untitled(SFc2_untitledInstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c2_u, 0U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  ...
  *chartInstance->c2_y = c2_b_y;
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c2_y, 1U);
}
...
static void init_simulink_io_address(SFc2_untitledInstanceStruct *chartInstance)
{
  chartInstance->c2_u = (uint8_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    0);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3688391478U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(534073307U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2283330443U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3521200121U);
}
...
mxArray *sf_c2_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("YVfV6GxpFtFzfBXx3Ay4ID");
...
static void mdlSetWorkWidths_c2_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1493860297U));
  ssSetChecksum1(S,(1473758507U));
  ssSetChecksum2(S,(1738634791U));
  ssSetChecksum3(S,(3176359634U));
